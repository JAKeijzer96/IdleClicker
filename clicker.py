...
class Clicker:
	def __init__(self, parent):
		...
		self.gear['noob gremlins'] = Gear('noob gremlin', ['Empower gremlins per noob owned: (%d): 0'],
		...
		self.gear['elbow grease'] = Gear('elbow grease', ['Click the old fashioned way: (%d): 0'],
			['Surprisingly easy.'], [5*10**5], per_second=5*10**5)
		self.gear['steam-powered clicker'] = Gear('steam-powered clicker', ['A steam-powered contraption that clicks: (%d): 0'],
			['I\'m sure it\'s steampunk. I see at least five clocks.'], [5*10**6], per_second=75*10**5)
